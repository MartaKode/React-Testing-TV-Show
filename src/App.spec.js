...
import { render, waitFor, fireEvent, findByTestId } from '@testing-library/react'
import App from './App'
...
//-fetching message should be rendered right away
//-API call initiated

await findByText(/fetching data.../i)

//API should be called; data shoould be rendered after we navigate into dropdown and pick a season
